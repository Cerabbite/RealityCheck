...
def get_compliments_and_roasts():
    response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": "You are giving people a reality check. Roast them based on 5 aspects, and also compliment them based on 5 aspects. The output should be in json format."},
